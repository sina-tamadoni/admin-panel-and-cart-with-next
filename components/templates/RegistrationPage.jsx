...
function RegistrationPage() {
  ...
  function submitHandler(e) {
    ...
    if (user.confirmPassword.trim() === "" || user.confirmPassword == null) {
      validationErrors.conpassErr = "وارد کردن تکرار رمز عبور الزامی است.";
    } else if (user.confirmPassword !== user.password) {
      validationErrors.conpassErr = "رمز وارد شده با رمز عبور یکسان نیست";
    }
    ...
    <div className="flex flex-col bg-gray-100 container mx-auto bg-transparent px-4 my-4 h-screen ">
      ...
      >
        <div className="flex flex-col justify-center items-center gap-7 mb-14">
          ...
          <h2 className="font-extrabold text-2xl">فرم ثبت نام</h2>
        </div>
        <input
        ...
        <Link href="/login" className="w-full text-[#55A3F0] my-4">
          حساب کاربری دارید؟
        </Link>
      </form>
    </div>
